...
# subsequent calls to import (I think) just link to the already
# loaded, and potentially modified module
# so...
...
# leftFakeFramesDir = '/Users/%s/Repositories/coxlab/cncController/inLogs/1289241336/cameras/49712223528793951' % os.getlogin()
# rightFakeFramesDir =
# '/Users/%s/Repositories/coxlab/cncController/inLogs/1289241336/cameras/49712223528793946'
# % os.getlogin()
...
# this 'defaultLog' contains useful things like camera localization and
# tc-cam mapping
...
externalCfgs = ['atlasCfg.py', 'cameraCfg.py', 'cncCfg.py', 'framesCfg.py',
                'electrodeCfg.py']
...
def start_logging():
    ...
    # cameraLogDir =
    # '/Users/%s/Repositories/coxlab/cncController/logs/camera/' %
    # os.getlogin()
    ...
    # framesLogDir =
    # '/Users/%s/Repositories/coxlab/cncController/logs/frames/' %
    # os.getlogin()
