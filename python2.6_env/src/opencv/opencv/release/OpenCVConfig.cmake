...
# ======================================================
INCLUDE_DIRECTORIES("/myPython/src/opencv/opencv/release" "/myPython/src/opencv/opencv/include" "/myPython/src/opencv/opencv/include/opencv")
# Provide the include directories to the caller
SET(OpenCV_INCLUDE_DIRS "/myPython/src/opencv/opencv/release" "/myPython/src/opencv/opencv/include" "/myPython/src/opencv/opencv/include/opencv")

# ======================================================
# Link directories to add to the user project:
# ======================================================
LINK_DIRECTORIES("/myPython/src/opencv/opencv/release/lib")
# Provide the libs directory anyway, it may be needed in some cases.
SET(OpenCV_LIB_DIR "/myPython/src/opencv/opencv/release/lib")
...
# ==============================================================
if(NOT "/myPython/src/opencv/opencv" STREQUAL  "")
	SET(BASEDIR "/myPython/src/opencv/opencv")
	foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
	...
	endforeach(__CVLIB)
endif(NOT "/myPython/src/opencv/opencv" STREQUAL  "")
