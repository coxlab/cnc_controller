...
{"GetOptimalNewCameraMatrix", (PyCFunction)pycvGetOptimalNewCameraMatrix, METH_KEYWORDS, "GetOptimalNewCameraMatrix(cameraMatrix, distCoeffs, imageSize, alpha, newCameraMatrix [, newImageSize [, validPixROI]]) -> None"},
...
{"KMeans2", pycvKMeans2, METH_VARARGS, "KMeans2(samples, nclusters, labels, termcrit) -> None"},
...
{"MatchShapes", (PyCFunction)pycvMatchShapes, METH_KEYWORDS, "MatchShapes(object1, object2, method [, parameter]) -> None"},
