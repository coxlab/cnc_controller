...
try:
    #print find_library('dc1394')
    #_dll = cdll.LoadLibrary('../../libdc1394.dylib')
    import os
    if not 'VIRTUAL_ENV' in os.environ.keys():
        print "Require environment variable VIRTUAL_ENV is not defined"
        raise RuntimeError
    venv = os.environ['VIRTUAL_ENV']
    print "VIRTUAL_ENV: %s" % (venv)
    _dll = cdll.LoadLibrary(venv+'/lib/libdc1394.dylib')
    print _dll
