...
class FiveAxisCNC:
    ...
    def __init__(self, cfgDict={}):
        ...
        self.linearAxes = Axes( self.cfg.get('linear_ip',"169.254.0.9"),
                                ...
                                self.cfg.get('linear_axes', {'x':1, 'y':2, 'z':3}),
    ...
    def configure(self):
        ...
        self.linearAxes.configure_axis('x', self.cfg['x_cfg'])#, cfg.xAxisConfig)
        self.linearAxes.configure_axis('y', self.cfg['y_cfg'])#cfg.yAxisConfig)
        self.linearAxes.configure_axis('z', self.cfg['z_cfg'])#cfg.zAxisConfig)
        ...
        self.headAxes.configure_axis('w', self.cfg['w_cfg'])#cfg.wAxisConfig)
